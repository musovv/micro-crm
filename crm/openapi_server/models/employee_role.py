...
class EmployeeRole(BaseModel):
    ...
    EmployeeRole - a model defined in OpenAPI
        ...
        id: The id of this EmployeeRole [Optional].
        login: The login of this EmployeeRole [Optional].
        first_name: The first_name of this EmployeeRole [Optional].
        last_name: The last_name of this EmployeeRole [Optional].
        roles: The roles of this EmployeeRole [Optional].
    """
    ...
    roles: Optional[object] = Field(alias="roles", default=None)
